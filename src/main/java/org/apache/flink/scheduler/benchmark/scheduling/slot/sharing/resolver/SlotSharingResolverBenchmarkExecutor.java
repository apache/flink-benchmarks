...
import static org.apache.flink.scheduler.benchmark.scheduling.slot.sharing.strategy.InitSlotSharingStrategyBenchmarkExecutor.JOB_VERTICES;
 ...
 */
public class SlotSharingResolverBenchmarkExecutor extends SchedulerBenchmarkExecutorBase {
    ...
    public void setup() throws Exception {
        benchmark = new SlotSharingResolverBenchmark(taskManagerLoadBalanceMode, JOB_VERTICES);
    }

    @Benchmark
    @BenchmarkMode(Mode.SingleShotTime)
    public void invokeSlotSharingResolver(Blackhole blackhole) {
        blackhole.consume(benchmark.invokeSlotSharingResolver());
    }
}
